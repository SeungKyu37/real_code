...
public class HumanExam01 {
	...
	public static void main(String[] args) {
		...
		System.out.print("Center2\t");	// \t는 tab의 길이만큼 띄운다.
		System.out.println("영등포");
		
		System.out.println("휴면" + "컴퓨터" + "학원");
		...
		// 4.1의미는 소수점 아래는 1자리만 사용하되, 2번째자리에서 반올림함.(화면에 보여질 때만)
		System.out.printf("10*human = %f \n", human1*10);
		// human1은 여전히 10.19라는 숫자를 가지고 있음을 알 수 있음.
		
		boolean	isStudent = true;	//논리 ==> %b
		...
		System.out.printf("제 이름은 %s이고, 제 닉네임은 %c입니다. 그리고 제 나이는 %d세. 오늘의 온도는 %4.1f도입니다. " + "당신은 학생입니다. = %b", name, nickName, age, temp, isStudent);
