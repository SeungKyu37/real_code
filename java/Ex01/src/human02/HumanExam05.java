...
public class HumanExam05 {
	...
	public static void main(String[] args) {
		...
		boolean result4 = (human1 != 100) && (human2 != 80);	// fasle, false ==> false
		...
		boolean result8 = (human1 != 100) || (human2 != 80);	// fasle, false ==> false
		...
		boolean result12 = (human1 != 100) ^ (human2 != 80);	// fasle, false ==> fasle
		System.out.printf("result12 = %b \n", result12);
		System.out.printf("--------------------------- \n");
		
		boolean result13 = !(human1 == 100);						// !true ==> false
		System.out.printf("result13 = %b \n", result13);
		
		boolean result14 = !((human1 == 100) || (human2 == 80));		// !true||true ==> fasle
		System.out.printf("result14 = %b", result14);
