...
//		List <String> list1 = new ArrayList<Stirng>();
		...
		int size = set1.size();	// set1 컬렉션 안에 있는 데이터 수
		System.out.println ("set1 size : " + size);
		boolean isEmpty = set1.isEmpty();	// set1 컬렉션이 비어있는 지를 판단하는 내용
...
//		}
		...
		// #2 두번째 방법.
		Iterator<String> iter = set1.iterator();	//set1의 값만큼 반복할 수 있는 환경을 만들어낸다.
		while(iter.hasNext()) {
